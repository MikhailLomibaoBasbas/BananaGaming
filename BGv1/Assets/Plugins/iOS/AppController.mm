...
#include "../Libraries/Facebook/FacebookUnityManager.h"
#include "../Libraries/MoreApps/MoreAppsUnityManager.h"
#include "../Libraries/Utilities/ViewControllerWrapper.h"
#include "../Libraries/Social/SocialUnityManager.h"
#include "../Libraries/MonoUtilityModules.h"
...
- (void) startUnity:(UIApplication*)application
{
    ...
    // create singleton instance of manager classes
...
-(void) ScheduledNotification: (NSInteger) interval
{
    ...
    [dateComps setDay:[dateComponents day] + interval];
    ...
    localNotif.alertBody = @"Lets Play Red's Revenge";
...
- (void) applicationDidBecomeActive:(UIApplication*)application
{
    ...
    if (_didResignActive) {
        ...
        if(![[MoreAppsUnityManager sharedManager] isViewControllerWrapperPresent] && ![[SocialUnityManager sharedManager] isViewControllerWrapperPresent]) {
            UnityPause(false);
        }*/
        UnityPause(false);
        //UnitySendMessage("z_AppDidBecomeActiveListener", "OnAppDidBecomeActiveCalled", "AppDidBecome Active is Called");
