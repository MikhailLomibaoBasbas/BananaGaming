...
public class WeaponDataController {
	...
	public WeaponDataController(){
		...
		Weapon pistol = new Weapon("5nrjh6oi5i", "Pistol", 0.4f, 800, 1, false, 0.3f, 0, 0, Weapon.WeaponType.Pistol, true);
		Weapon shotGun = new Weapon("ok0ck8z9sn", "Shotgun", 0.2f, 500, 5, true, 1.5f, 30, 30, Weapon.WeaponType.Shotgun, true); // Instant
		Weapon ak47 = new Weapon("5fogt8di5i", "AK47", 0.3f, 1200, 2, false, 0.1f,  200, 200, Weapon.WeaponType.AK47, true);
